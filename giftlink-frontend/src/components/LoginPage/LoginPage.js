...
function LoginPage() {
    ...
    // Step 1 - Task 4: State for incorrect password message
    const [incorrect, setIncorrect] = useState('');

    // Step 1 - Task 5: Local variables for navigate, bearerToken, setIsLoggedIn
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            // Step 1 - Tasks 7, 8, 9: API call with method, headers, body
            ...
            // Step 2 - Task 1: Access data in JSON format
